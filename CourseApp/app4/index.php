                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">
                                                        <?php if (strlen($courses["1"]["subtitle"])>50): ?>
                                                            <?php echo substr($courses["1"]["subtitle"], 0, 50)."..."; ?>

                                                        <?php else: ?>
                                                            <?php echo $courses["1"]["subtitle"]; ?>
                                                    ...
                                                    <p>
                                                        <?php if ($courses["1"]["like"]>0): ?>
                                                            <span class="badge rounded-pill text-bg-primary">
                                                                <?php echo $courses["1"]["like"]; ?> Likes
                                                            </span>
                                                        <?php endif ?>
                                                        <?php if ($courses["1"]["comment"]>0): ?>
                                                            <span class="badge rounded-pill text-bg-danger">
                                                                <?php echo $courses["1"]["comment"]; ?> Comments
                                                            </span>
                                                        <?php else: ?>
